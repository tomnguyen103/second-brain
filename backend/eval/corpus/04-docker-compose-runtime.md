...
pgvector extension, and Redis for caching. Locally the database uses the `pgvector/pgvector:pg16`
image and publishes on host port 5433, because a native PostgreSQL already occupies the default
5432. Keeping the whole stack in Compose makes the deployment cheap, reproducible, and easy to
