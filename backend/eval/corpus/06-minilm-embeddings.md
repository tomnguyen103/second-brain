...
— no text leaves the machine for embedding — and it runs only at ingest time, not on every
query path beyond embedding the question itself. The 384-dimension vectors are stored in a
